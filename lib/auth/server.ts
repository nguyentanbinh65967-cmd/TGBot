/**
 * Серверные функции авторизации (для использования в Server Components, API Routes, Middleware)
 * 
 * ВАЖНО: Эти функции используют node:crypto и должны вызываться только на сервере.
 */
